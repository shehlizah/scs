...
class MonitoringcctvController extends ControllerBase
{
    protected $apiOut;
	...
	{ 
		$builder = $this->modelsManager->createBuilder()  
			->columns('
                 CctvSekolah.id
                ,CctvSekolah.cctv_name
                ,CctvSekolah.uri
                ,CctvSekolah.sekolah
                ,CctvSekolah.rombel
                ,CctvSekolah.tingkat
                ,CctvSekolah.created_at
                ,CctvSekolah.created_by
                ,CctvSekolah.updated_at
                ,CctvSekolah.updated_by
                ,CctvSekolah.ip_address
                ,CctvSekolah.publish_port
                ,CctvSekolah.status_active
			')
	...
	{ 
		if($id!=false) {
			$row=CctvSekolah::findFirstById($id);
            $old=$row;
			if($row) {
				if($this->request->isPost()) {
