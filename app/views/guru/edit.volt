                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input 
                                    ...
                                    id="nuptk" 
                                    class="form-control" 
                                    value="{{data.row.nuptk}}" 
                                    >
                            </div>

                            <div class="mb-3">
                                <label for="image_path" class="form-label">Foto Enrollment FR</label>
                                {{ data.image_path }}
                                <input type="file" name="image_path" data-plugins="dropify" data-max-file-size="5M"  />                              
                            </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="input-group">
                                            <input 
                                                ...
                                                id="tgl_surat_tugas" 
                                                value="{{data.row.tgl_surat_tugas}}" 
                                                class="form-control datepicker_dmy" 
                                                >   
                                            <span class="input-group-text" id="basic-addon1">
                                                <i class="fe-calendar"></i>
