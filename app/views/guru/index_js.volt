            ...
            "columnDefs": [
                {
                    ...
                    "render": function(data, type, row, meta){
                        ...
                        var link_del=`<a href='/{{page.access.resources_name}}/index/delete?uid=`+row.id+`' 
                            uid="`+row.id+`" 
                            title="Hapus Data Guru : `+row.nama_lengkap+`" 
                            text="Data Guru `+row.nisn+` - `+row.nama_lengkap+` akan dihapus" 
                    ...
                    "render": function(data, type, row, meta){
                        ...
                        if(row.image_path != null) {
                            ...
                            <a href="/`+row.image_path+`" target="_blank">
                                <img witdh="80" src="/`+row.image_path+`" alt="`+row.nama_lengkap+`" style="margin-right: 0px; max-width: 100px;">
                            </a>
                            `;
                        }
