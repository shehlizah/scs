...
{% block content %}
    ...
    <div class="container-fluid">
        ...
        <div class="card-header">
            <h4 class="card-title m-b-0">Data Guru</h4>
        </div>
        <div class="card-body">
            <div class="table-responsive">
            <div class="table-wrapper">
            <div class="table-action-head">
					<a href="/guru/create" class="btn btn-primary"><i class="ti ti-plus"></i>&nbsp;&nbsp; Tambah Data</a>
					<!-- <a href="#modal-hapussemua" data-toggle="modal" data-target="#modal-hapussemua" class="btn btn-danger"><i class="ti ti-trash"></i>&nbsp;&nbsp; Hapus data yang dipilih</a> -->
					<!--
                    <a href="/dataguru/cetakguru/?halaman=1" class="btn btn-warning" style="background: #086966;border-color: #0a7c78;"><i class="fa fa-download"></i>&nbsp;&nbsp; Export Excel</a>
					<a href="/pelatihan" class="btn btn-info"><i class="fa fa-users"></i>&nbsp;&nbsp; Pelatihan</a>
					<a href="/dataguru/penugasan" class="btn btn-warning"><i class="ti ti-user"></i>&nbsp;&nbsp; Penugasan</a>
                    -->
				</div>
                ...
                <tbody>
                    ...
                    foreach($data->items as $item) {
                        ...
                        <td><?=$item->tgllahir?></td>
                        <td><?=$item->statuskepegawaian?></td>
                        <td><?=$item->tglmasuk?></td>
                        <td style="width: 180px;">
                            <form action="/guru" method="post" class="siswaftupload" enctype="multipart/form-data">
                            <input type="hidden" name="simpanfoto" value="simpan" />
                            <input type="hidden" class="form-control nisnsiswa" name="nisn" value="<?=$item->id?>">
                        ...
                        <div class="btn-group">
                            <button data-toggle="dropdown" class="btn btn-default dropdown-toggle" type="button">Action <span class="caret"></span>
                            </button>
                            <ul class="dropdown-menu">
                                <li><a href="/guru/edit/<?=$item->id;?>">Edit</a></li>
                                <li><a href="#modal-hapus27" data-toggle="modal" data-target="#modal-hapus27">Hapus</a></li>
                            </ul>
                        </div>
                        </td>
                        </tr>
                ...
                <div class="modal-dialog">
                    <form action="https://demo.sekolahan.id/siswaedit/import/?halaman=1&snamasiswa=a" method="post" enctype="multipart/form-data">
                    <div class="modal-content" id="myModalLabel">
                        <div class="modal-header theme-bg">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        </div>
                        <div class="modal-body">
                        <div class="row">
                            <h5 style="margin-left:15px;margin-bottom:30px;">Download Template Format Excel : <a href="https://demo.sekolahan.id/siswaedit/excelimport/?export=1&snamasiswa=a" style="margin-left:15px;">Download</a>
                            </h5>
                        </div>
