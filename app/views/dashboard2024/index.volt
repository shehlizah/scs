                            ...
                            <div class="text-end">
                                <h3 class="text-dark mt-1">
                                    <span data-plugin="counterup">
                                        <?php 
echo count($data->list_heartbeat); 
// echo 0;
...
<!-- data hearbeat
<?php echo json_encode($data->list_heartbeat); ?>
-->
                                    </span>
                                </h3>
                        ...
                        <div class="col-8">
                            <div class="text-end">
                                <h3 class="text-dark mt-1">
                                    <span data-plugin="counterup">
                                        <?php 
echo count($data->list_sekolah) - count($data->list_heartbeat); 
// echo 153;
?>                                        
                                    </span>
                                </h3>
                        ...
                        <table class="table table-sm mb-0">
                            ...
                            <tbody>
                                ...
                                if (count($data->list_heartbeat) > 0) {
                                    ...
                                    // echo json_encode($data->list_heartbeat);
