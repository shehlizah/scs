			...
			// },
			{
				...
				"render": function(data, type, row, meta){
					...
					if(row.photo_url != null) {
						image_64=`
						<a href="https://api.disdiksulsel.id/`+row.photo_url+`" target="_blank">
							<img witdh="80" src="https://api.disdiksulsel.id/`+row.photo_url+`" alt="`+row.nama_siswa+`" style="margin-right: 0px; max-width: 100px;">
						</a>
						`;
					}
