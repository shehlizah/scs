                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea 
                                    ...
                                    id="soal_text" 
                                    name="soal_text" 
                                    rows="5">{{ data.row.soal_text }}</textarea>
                            </div>
